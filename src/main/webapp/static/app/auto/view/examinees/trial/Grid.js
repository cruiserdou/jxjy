...
Ext.define('App.view.examinees.trial.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.audits_grid',
    store: 'syj_trainer_trial',
    selModel: sm,
    id :'grid_audits_trainer',
    listeners: {
        itemclick: function (this_, record_) {
            var audits_trainer_panel = Ext.getCmp('audits_trainer_info');
            audits_trainer_panel.tpl.overwrite(audits_trainer_panel.body, record_.data);
        }
    },
