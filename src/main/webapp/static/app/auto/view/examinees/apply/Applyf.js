...
Ext.define('App.view.examinees.apply.Applyf', {
    ...
    applyTpl: [
        ...
        '<input type="checkbox" id="apply_form_id_licmd_goods" name="licmd_goods" value="道路货物运输"/>道路货物运输&nbsp;',
        '<input type="checkbox" id="apply_form_id_checklist1" name="checklist1" value="道路危险货物运输"/>道路危险货物运输&nbsp;',
        '<input type="checkbox" id="apply_form_id_checklist2" name="checklist2" value="出租客运"/>出租客运&nbsp;',
        '</td>',
        '</tr>',
        '<tr>',
