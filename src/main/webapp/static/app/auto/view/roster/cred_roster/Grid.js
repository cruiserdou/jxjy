Ext.define('App.view.roster.cred_roster.Grid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.cred_rosterf_grid',
    store: 'syj_trainer_results',
    id :'grid_cred_roster',
    listeners: {
        itemclick: function (this_, record_) {
            var cred_rosterf_panel = Ext.getCmp('cred_roster_info');
            cred_rosterf_panel.tpl.overwrite(cred_rosterf_panel.body, record_.data);
        }
    },
    initComponent: function () {
        ...
        this.columns = [
            ...
            {text: '住址', width: 130, dataIndex: 'address'},
            ...
            {text: '是否同意考试', width: 110, dataIndex: 'status'},
