...
<head>
    ...
    <script>
        ...
        function to_print_click(card) {
            var i = 6;
            function shownum(){
                i=i-1;
                setTimeout('to_print_click()',1000); }
    ...
    <script type="text/javascript" src="static/xtemplate/main_exam_print_score.js"></script>
</head>
<body>
