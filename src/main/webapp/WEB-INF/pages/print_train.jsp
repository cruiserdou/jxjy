...
<div id="wrap">
    ...
    <table   style=" width: 100%;margin:auto border:1px solid red;border-collapse:collapse;">
        ...
        <td colspan="1" width="27%">工作单位或家庭住址</td>
        <td colspan="1" width="10%">准驾车型</td>
        <td colspan="1" width="10%">驾照初领日期</td>
        <td colspan="1" width="20%">资格类别</td>
        </tr>
        <%
            sqlBean db = new sqlBean();
            String sql = "select name,sex,card,address,lictype,licdt,licmd from work.trainer where status='同意考试'";
        ...
        <tr>
            ...
            <td colspan="1" width="27%"><%=rs.getString("address")%></td>
            <td colspan="1" width="10%"><%=rs.getString("lictype")%></td>
