...
@Controller
@RequestMapping("/print_examxls_info")
public class ExportXlsExam {
    ...
    DataShop getShopInJSON(
        ...
        try{
            ...
            String sql = "select RANK() OVER(ORDER BY id) as 序号,name as 姓名,sex as 性别,card as 身份证号,address as  工作单位或家庭住址," +
                    "lictype as 准驾车型,licdt as 驾照初领日期,licmd as 资格类别,'同意' as 是否同意考试,'' as 成绩,'' as 备注 " +
                    " from work.examinees where status='审核'";
...
//            font0.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD);
            ...
            ce.setCellValue(new HSSFRichTextString("武威市道路运输行业从业人员培训、考试、制证、发证登记册"));
