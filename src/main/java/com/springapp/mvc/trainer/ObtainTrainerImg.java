...
@Controller
@RequestMapping("/obtain_train_img_info")
public class ObtainTrainerImg {
    ...
    DataShop getShopInJSON(
        ...
        try{
            ...
            String sql = "select  img1,img2, img3 from work.tb_examing_img img where    \n" +
                    " img.id in (select max(img.id) from work.tb_examing_img    img , work.trainer trainer " +
                    "  where   img.id_card= trainer.card  and trainer.id="+session.getAttribute("id").toString()+")";
