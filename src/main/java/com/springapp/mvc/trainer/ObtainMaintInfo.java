...
@Controller
@RequestMapping("/obtain_maints_info")
public class ObtainMaintInfo {
    ...
    DataShop getShopInJSON(
        ...
        try{
            ...
            String sql = "select * from work.trainer WHERE  drvschool='"+s_drvschool+"'  and status in ('报名','不合格','不及格','违纪') ";
