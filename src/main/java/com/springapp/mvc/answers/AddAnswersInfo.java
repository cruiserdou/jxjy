...
public class AddAnswersInfo {
    ...
    DataShop getShopInJSON(
        ...
        try {
            ...
            int s_scores = 0;
            String sql_scores = " select scores  from   work.trainer  WHERE card ='" + admbh + "'";
            rs_scores = stmt.executeQuery(sql_scores);
            while (rs_scores.next()) {
                s_scores = rs_scores.getInt(1);
            }
